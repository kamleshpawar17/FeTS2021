...
from models import EncoderDecoderModuleUnetPP
import torch
...
ap.add_argument("-cp", "--checkpoint_path", type=str, default='../weights/stage2/Unetpp-resnet50-scse/')
...
if __name__ == '__main__': 
    # ----- model defination ---- #
    model = EncoderDecoderModuleUnetPP(in_chans=4, out_chans=4,  encoder_name='resnet50',  encoder_weights="imagenet", decoder_attention_type='scse', weight_decay=0.0, lossWeight={'dice':1.0, 'CE':0.0}, lr=0.0005, red_lr_pla_factor=0.75, red_lr_pla_patience=15)
