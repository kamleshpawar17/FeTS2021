...
ap.add_argument("-cp", "--checkpoint_path", type=str, default='../weights/stage2/FPN-inceptionresnetv2/')
...
if __name__ == '__main__': 
    # ----- model defination ---- #
    model = EncoderDecoderModuleFPN(in_chans=4, out_chans=4,  encoder_name='inceptionresnetv2',  encoder_weights="imagenet", decoder_attention_type='scse', weight_decay=0.0, lossWeight={'dice':1.0, 'CE':0.0}, lr=0.0002, red_lr_pla_factor=0.75, red_lr_pla_patience=15)
